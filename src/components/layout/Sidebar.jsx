...
const menuItems = [
  ...
  { to: '/visits', icon: Stethoscope, label: 'الكشوفات', roles: ['doctor'] },
  { to: '/lab', icon: FlaskConical, label: 'الفحوصات', roles: ['doctor', 'nurse'] },
  { to: '/prescriptions', icon: Pill, label: 'الوصفات', roles: ['doctor'] },
